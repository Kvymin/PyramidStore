...
class Spider(Spider):
    ...
    def playerContent(self, flag, pid, vipFlags):
        ...
        # _id = info[0]
        # _pid = info[1]
        # url = self.home_url + f'/vod/play/{_id}/sid/{_pid}'
    ...
    def get_data(self, url):
        ...
        try:
            ...
            # vod_year_s = re.findall(r'\\"vodYear\\":\\"(.*?)\\"', res.text)
            # print(vod_id_s)
            # print(vod_name_s)
            # print(vod_pic_s)
            # print(vod_remarks_s)
    ...
    def get_headers(t, e):
        ...
        headers = {
            ...
            # 'deviceid': '09122076-b8d5-4502-8daa-61d75e048510',
            't': t,
